...
# Demonstration Video
I also publish the demonstration video on youtube: https://youtu.be/z4InG4KTPCs
...
I also like how GNU Radio organize the Google Summer of Code, for example I am required to post a progress report update to the mailing list, to make people know about my project and it give me some publication (I also get another oportunity to work on Software Defined Radio because someone my posts on GNU Radio Community). I will highly reccomended people to look into GNU Radio organizations for next years Google Summer of Code.

I will continue to contribute to GNU Radio after GSoC projects!
